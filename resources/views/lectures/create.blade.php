                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('lectures.store', $course) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="video_url" id="video_url" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            @error('video_url')
                                <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                            @enderror
                        </div>
