        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col">
                        <a href="{{ route('tests.show', [$course, $lecture, $lecture->tests()->first()]) }}" class="text-white bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded my-4">Take Test</a>
                    </div>
                </div>
                ...
                <div class="p-6 text-gray-900 flex">
                    <a href="{{ route('tests.create', [$course, $lecture]) }}" class="text-white bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded my-4">Create Test</a>
